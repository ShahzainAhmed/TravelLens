...
class AppTypography {
  ...
  static TextStyle kMedium20 =
      GoogleFonts.outfit(fontSize: 20.sp, fontWeight: FontWeight.w500);
  ...
  static TextStyle kBold14 =
      GoogleFonts.outfit(fontSize: 14.sp, fontWeight: FontWeight.w600);

  static TextStyle kExtraLight8 =
      GoogleFonts.outfit(fontSize: 8.sp, fontWeight: FontWeight.w300);

  static TextStyle kExtraLight10 =
      GoogleFonts.outfit(fontSize: 10.sp, fontWeight: FontWeight.w300);
  ...
  static TextStyle kExtraLight22 =
      GoogleFonts.outfit(fontSize: 22.sp, fontWeight: FontWeight.w300);

  static TextStyle kExtraLight24 =
      GoogleFonts.outfit(fontSize: 24.sp, fontWeight: FontWeight.w300);

  static TextStyle kExtraLight26 =
      GoogleFonts.outfit(fontSize: 26.sp, fontWeight: FontWeight.w300);
  ...
  static TextStyle kLight6 =
      GoogleFonts.outfit(fontSize: 6.sp, fontWeight: FontWeight.w400);

  static TextStyle kLight8 =
      GoogleFonts.outfit(fontSize: 8.sp, fontWeight: FontWeight.w400);
  ...
  static TextStyle kLight30 =
      GoogleFonts.outfit(fontSize: 30.sp, fontWeight: FontWeight.w400);

  static TextStyle kLight32 =
      GoogleFonts.outfit(fontSize: 32.sp, fontWeight: FontWeight.w400);

  static TextStyle kLight36 =
      GoogleFonts.outfit(fontSize: 36.sp, fontWeight: FontWeight.w400);
  //Medium

  static TextStyle kMedium10 =
      GoogleFonts.outfit(fontSize: 10.sp, fontWeight: FontWeight.w500);

  static TextStyle kMedium12 =
      GoogleFonts.outfit(fontSize: 12.sp, fontWeight: FontWeight.w500);

  static TextStyle kMedium16 =
      GoogleFonts.outfit(fontSize: 16.sp, fontWeight: FontWeight.w500);

  static TextStyle kMedium18 =
      GoogleFonts.outfit(fontSize: 18.sp, fontWeight: FontWeight.w500);

  static TextStyle kMedium22 =
      GoogleFonts.outfit(fontSize: 22.sp, fontWeight: FontWeight.w500);

  static TextStyle kMedium26 =
      GoogleFonts.outfit(fontSize: 26.sp, fontWeight: FontWeight.w500);

  static TextStyle kMedium30 =
      GoogleFonts.outfit(fontSize: 30.sp, fontWeight: FontWeight.w500);

  //Bold

  static TextStyle kBold6 =
      GoogleFonts.outfit(fontSize: 6.sp, fontWeight: FontWeight.w600);

  static TextStyle kBold10 =
      GoogleFonts.outfit(fontSize: 10.sp, fontWeight: FontWeight.w600);

  static TextStyle kBold12 =
      GoogleFonts.outfit(fontSize: 12.sp, fontWeight: FontWeight.w600);
  ...
  static TextStyle kBold22 =
      GoogleFonts.outfit(fontSize: 22.sp, fontWeight: FontWeight.w600);

  static TextStyle kBold24 =
      GoogleFonts.outfit(fontSize: 24.sp, fontWeight: FontWeight.w600);

  static TextStyle kBold26 =
      GoogleFonts.outfit(fontSize: 26.sp, fontWeight: FontWeight.w600);
  ...
  static TextStyle kBold40 =
      GoogleFonts.outfit(fontSize: 40.sp, fontWeight: FontWeight.w600);

  // Extra Bold
  static TextStyle kExtraBold10 =
      GoogleFonts.outfit(fontSize: 10.sp, fontWeight: FontWeight.w700);

  static TextStyle kExtraBold12 =
      GoogleFonts.outfit(fontSize: 12.sp, fontWeight: FontWeight.w700);

  static TextStyle kExtraBold14 =
  ...
  static TextStyle kExtraBold30 =
      GoogleFonts.outfit(fontSize: 30.sp, fontWeight: FontWeight.w700);
  ...
  static TextStyle kExtraBold56 = GoogleFonts.outfit(
    fontSize: 56.sp,
